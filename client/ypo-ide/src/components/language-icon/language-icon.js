    ...
    return (
      <div className={'language-icon ' + (this.state.theme + ' ')} onClick={() => {this.onClick()}}>
        <svg viewBox="0 0 255 255">
          ...
          <line x1="47.5" y1="95.5" x2="207.5" y2="95.5" strokeLinecap="round" strokeWidth="16" stroke="black" fill="transparent"/>
          <line x1="47.5" y1="159.5" x2="207.5" y2="159.5" strokeLinecap="round" strokeWidth="16" stroke="black" fill="transparent"/>
